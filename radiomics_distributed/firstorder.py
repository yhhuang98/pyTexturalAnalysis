...
class RadiomicsFirstOrder(base.RadiomicsFeaturesBase):
  ...
  def __init__(self, inputImage, inputMask, **kwargs):
    ...
    self.kernelOffsets = None
    self.voxelArrayShift = kwargs.get('voxelArrayShift', 0)
    self.discretizedImageArray = self._applyBinning()


  def _initVoxelBasedCalculation(self, left_margins=None, right_margins=None):
    super(RadiomicsFirstOrder, self)._initVoxelBasedCalculation(left_margins=left_margins, right_margins=right_margins)
  ...
  def _calculateCoefficients(self, voxelCoordinates=None):
    if voxelCoordinates is None:
      targetVoxelArray = self.imageArray[self.maskArray].astype('float').reshape((1, -1))
      ...
      targetVoxelArray = self.imageArray[kernelCoords]  # shape (Nvox, Nk)
    ...
    coefficients = dict()
    coefficients['p_i'] = p_i
    coefficients['pixelSpacing'] = self.coefficients['pixelSpacing']
    coefficients['targetVoxelArray'] = targetVoxelArray
    coefficients['voxelArrayShift'] = self.voxelArrayShift
  ...
  @staticmethod
  def getEnergyFeatureValue(coefficients):
    r"""
    **1. Energy**
    ...
    """
    targetVoxelArray = coefficients['targetVoxelArray']
    shiftedParameterArray = targetVoxelArray + coefficients['voxelArrayShift']

    return numpy.nansum(shiftedParameterArray ** 2, 1)

  @staticmethod
  def getTotalEnergyFeatureValue(coefficients):
    r"""
    **2. Total Energy**
    ...
    cubicMMPerVoxel = numpy.multiply.reduce(coefficients['pixelSpacing'])

    return RadiomicsFirstOrder.getEnergyFeatureValue(coefficients) * cubicMMPerVoxel

  @staticmethod
  def getEntropyFeatureValue(coefficients):
    r"""
    **3. Entropy**
  ...
  @staticmethod
  def getMinimumFeatureValue(coefficients):
    r"""
    **4. Minimum**
    ...
    return numpy.nanmin(coefficients['targetVoxelArray'], 1)

  @staticmethod
  def get10PercentileFeatureValue(coefficients):
    r"""
    **5. 10th percentile**

    The 10\ :sup:`th` percentile of :math:`\textbf{X}`
    """
    return numpy.nanpercentile(coefficients['targetVoxelArray'], 10, axis=1)

  @staticmethod
  def get90PercentileFeatureValue(coefficients):
    r"""
    **6. 90th percentile**
    ...
    return numpy.nanpercentile(coefficients['targetVoxelArray'], 90, axis=1)

  @staticmethod
  def getMaximumFeatureValue(coefficients):
    r"""
    **7. Maximum**
    ...
    return numpy.nanmax(coefficients['targetVoxelArray'], 1)

  @staticmethod
  def getMeanFeatureValue(coefficients):
    r"""
    **8. Mean**
    ...
    return numpy.nanmean(coefficients['targetVoxelArray'], 1)

  @staticmethod
  def getMedianFeatureValue(coefficients):
    r"""
    **9. Median**
    ...
    return numpy.nanmedian(coefficients['targetVoxelArray'], 1)

  @staticmethod
  def getInterquartileRangeFeatureValue(coefficients):
    r"""
    **10. Interquartile Range**
    ...
    return numpy.nanpercentile(coefficients['targetVoxelArray'], 75, 1) - numpy.nanpercentile(coefficients['targetVoxelArray'], 25, 1)

  @staticmethod
  def getRangeFeatureValue(coefficients):
    r"""
    **11. Range**
    ...
    return numpy.nanmax(coefficients['targetVoxelArray'], 1) - numpy.nanmin(coefficients['targetVoxelArray'], 1)

  @staticmethod
  def getMeanAbsoluteDeviationFeatureValue(coefficients):
    r"""
    **12. Mean Absolute Deviation (MAD)**
    ...
    u_x = numpy.nanmean(coefficients['targetVoxelArray'], 1, keepdims=True)
    return numpy.nanmean(numpy.absolute(coefficients['targetVoxelArray'] - u_x), 1)

  @staticmethod
  def getRobustMeanAbsoluteDeviationFeatureValue(coefficients):
    r"""
    **13. Robust Mean Absolute Deviation (rMAD)**
    ...
    prcnt10 = RadiomicsFirstOrder.get10PercentileFeatureValue(coefficients)
    prcnt90 = RadiomicsFirstOrder.get90PercentileFeatureValue(coefficients)
    percentileArray = coefficients['targetVoxelArray'].copy()
  ...
  @staticmethod
  def getRootMeanSquaredFeatureValue(coefficients):
    r"""
    **14. Root Mean Squared (RMS)**
    ...
    targetVoxelArray = coefficients['targetVoxelArray']
    if targetVoxelArray.size == 0:
      return 0

    shiftedParameterArray = targetVoxelArray + coefficients['voxelArrayShift']
    Nvox = numpy.sum(~numpy.isnan(targetVoxelArray), 1).astype('float')
    return numpy.sqrt(numpy.nansum(shiftedParameterArray ** 2, 1) / Nvox)


  @staticmethod
  @deprecated
  def getStandardDeviationFeatureValue(coefficients):
    r"""
    **15. Standard Deviation**
    ...
    return numpy.nanstd(coefficients['targetVoxelArray'], axis=1)

  @staticmethod
  def getSkewnessFeatureValue(coefficients):
    r"""
    **16. Skewness**
    ...
    """
    targetVoxelArray = coefficients['targetVoxelArray']
    m2 = RadiomicsFirstOrder._moment(targetVoxelArray, 2)
    m3 = RadiomicsFirstOrder._moment(targetVoxelArray, 3)
  ...
  @staticmethod
  def getKurtosisFeatureValue(coefficients):
    r"""
    **17. Kurtosis**
    ...
    targetVoxelArray = coefficients['targetVoxelArray']
    m2 = RadiomicsFirstOrder._moment(targetVoxelArray, 2)
    m4 = RadiomicsFirstOrder._moment(targetVoxelArray, 4)
  ...
  @staticmethod
  def getVarianceFeatureValue(coefficients):
    r"""
    **18. Variance**
    ...
    return numpy.nanstd(coefficients['targetVoxelArray'], 1) ** 2

  @staticmethod
  def getUniformityFeatureValue(coefficients):
    r"""
    **19. Uniformity**
