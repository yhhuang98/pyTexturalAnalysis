...
from . import base, cShape, deprecated
...
class RadiomicsShape(base.RadiomicsFeaturesBase):
  ...
  def __init__(self, imageArray, maskArray, **kwargs):
    assert maskArray.ndim == 3, 'Shape features are only available in 3D. If 2D, use shape2D instead'
    super(RadiomicsShape, self).__init__(imageArray, maskArray, **kwargs)
  ...
  def _calculateCoefficients(self, voxelCoordinates=None):
    ...
    self.coefficients['pixelSpacing'] = numpy.array(self.coefficients['pixelSpacing'][::-1])
    ...
    SurfaceArea, Volume, diameters = cShape.calculate_coefficients(self.maskArray, self.coefficients['pixelSpacing'])
    ...
    physicalCoordinates = coordinates * self.coefficients['pixelSpacing'][None, :]
    ...
    machine_errors = numpy.bitwise_and(eigenValues < 0, eigenValues > -1e-10)
    ...
    coefficients = dict()
    coefficients['SurfaceArea'] = SurfaceArea
    coefficients['Volume'] = Volume
    coefficients['diameters'] = diameters
    coefficients['eigenValues'] = eigenValues
    coefficients['Np'] = Np
  ...
  @staticmethod
  def getMeshVolumeFeatureValue(coefficients):
    r"""
    **1. Mesh Volume**
  ...
  @staticmethod
  def getVoxelVolumeFeatureValue(coefficients):
    r"""
    **2. Voxel Volume**
    ...
    """
    z, y, x = coefficients['pixelSpacing']
    Np = coefficients['Np']
    return Np * (z * x * y)

  @staticmethod
  def getSurfaceAreaFeatureValue(coefficients):
    r"""
    **3. Surface Area**
    ...
    """
    return coefficients['SurfaceArea']

  @staticmethod
  def getSurfaceVolumeRatioFeatureValue(coefficients):
    r"""
    **4. Surface Area to Volume ratio**
    ...
    """
    return coefficients['SurfaceArea'] / coefficients['Volume']

  @staticmethod
  def getSphericityFeatureValue(coefficients):
    r"""
    **5. Sphericity**
    ...
    """
    return (36 * numpy.pi * coefficients['Volume'] ** 2) ** (1.0 / 3.0) / coefficients['SurfaceArea']


  @staticmethod
  @deprecated
  def getCompactness1FeatureValue(coefficients):
    r"""
    **6. Compactness 1**
    ...
    .. note::
      ...
      features.
    """
    return coefficients['Volume'] / (coefficients['SurfaceArea'] ** (3.0 / 2.0) * numpy.sqrt(numpy.pi))


  @staticmethod
  @deprecated
  def getCompactness2FeatureValue(coefficients):
    r"""
    **7. Compactness 2**
    ...
    .. note::
      ...
      features.
    """
    return (36.0 * numpy.pi) * (coefficients['Volume'] ** 2.0) / (coefficients['SurfaceArea'] ** 3.0)


  @staticmethod
  @deprecated
  def getSphericalDisproportionFeatureValue(coefficients):
    r"""
    **8. Spherical Disproportion**
    ...
    .. note::
      ...
      features.
    """
    return coefficients['SurfaceArea'] / (36 * numpy.pi * coefficients['Volume'] ** 2) ** (1.0 / 3.0)

  @staticmethod
  def getMaximum3DDiameterFeatureValue(coefficients):
    r"""
    **9. Maximum 3D diameter**
    ...
    """
    return coefficients['diameters'][3]

  @staticmethod
  def getMaximum2DDiameterSliceFeatureValue(coefficients):
    r"""
    **10. Maximum 2D diameter (Slice)**
    ...
    """
    return coefficients['diameters'][0]

  @staticmethod
  def getMaximum2DDiameterColumnFeatureValue(coefficients):
    r"""
    **11. Maximum 2D diameter (Column)**
    ...
    """
    return coefficients['diameters'][1]

  @staticmethod
  def getMaximum2DDiameterRowFeatureValue(coefficients):
    r"""
    **12. Maximum 2D diameter (Row)**
    ...
    """
    return coefficients['diameters'][2]

  @staticmethod
  def getMajorAxisLengthFeatureValue(coefficients):
    r"""
    **13. Major Axis Length**
    ...
    """
    eigenValues = coefficients['eigenValues']
    if eigenValues[2] < 0:
      logger = logging.getLogger(RadiomicsShape.__module__)
      logger.warning('Major axis eigenvalue negative! (%g)', eigenValues[2])
      return numpy.nan
    return numpy.sqrt(eigenValues[2]) * 4

  @staticmethod
  def getMinorAxisLengthFeatureValue(coefficients):
    r"""
    **14. Minor Axis Length**
    ...
    if eigenValues[1] < 0:
      ...
      return numpy.nan
    return numpy.sqrt(eigenValues[1]) * 4

  @staticmethod
  def getLeastAxisLengthFeatureValue(coefficients):
    r"""
    **15. Least Axis Length**
    ...
    if eigenValues[0] < 0:
      ...
      return numpy.nan
    return numpy.sqrt(eigenValues[0]) * 4

  @staticmethod
  def getElongationFeatureValue(coefficients):
    r"""
    **16. Elongation**
    ...
    if eigenValues[1] < 0 or eigenValues[2] < 0:
      logger = logging.getLogger(RadiomicsShape.__module__)
      logger.warning('Elongation eigenvalue negative! (%g, %g)', eigenValues[1], eigenValues[2])
      return numpy.nan
    return numpy.sqrt(eigenValues[1] / eigenValues[2])

  @staticmethod
  def getFlatnessFeatureValue(coefficients):
    r"""
    **17. Flatness**
    ...
    if eigenValues[0] < 0 or eigenValues[2] < 0:
      logger = logging.getLogger(RadiomicsShape.__module__)
      logger.warning('Elongation eigenvalue negative! (%g, %g)', eigenValues[0], eigenValues[2])
      return numpy.nan
    return numpy.sqrt(eigenValues[0] / eigenValues[2])
