...
class RadiomicsShape2D(base.RadiomicsFeaturesBase):
  ...
  def __init__(self, imageArray, maskArray=None, **kwargs):
    super(RadiomicsShape2D, self).__init__(imageArray, maskArray, **kwargs)
  ...
  def _calculateCoefficients(self, voxelCoordinates=None):
    ...
    if Nd == 3:
      ...
      self.coefficients['pixelSpacing'] = numpy.array(self.coefficients['pixelSpacing'][::-1])[(axes,)]
    ...
    Perimeter, Surface, Diameter = cShape.calculate_coefficients2D(self.maskArray, self.coefficients['pixelSpacing'])
    ...
    coefficients = dict()
    coefficients['Perimeter'] = Perimeter
    coefficients['Surface'] = Surface
    coefficients['Diameter'] = Diameter
  ...
  @staticmethod
  def getMeshSurfaceFeatureValue(coefficients):
    r"""
    **1. Mesh Surface**
    ...
    """
    return coefficients['Surface']

  @staticmethod
  def getPixelSurfaceFeatureValue(coefficients):
    r"""
    **2. Pixel Surface**
    ...
    y, x = coefficients['pixelSpacing']
    Np = coefficients['Np']
    return Np * (x * y)

  @staticmethod
  def getPerimeterFeatureValue(coefficients):
    r"""
    **3. Perimeter**
  ...
  @staticmethod
  def getPerimeterSurfaceRatioFeatureValue(coefficients):
    r"""
    **4. Perimeter to Surface ratio**
    ...
    """
    return coefficients['Perimeter'] / coefficients['Surface']
  ...
  def getSphericityFeatureValue(coefficients):
    ...
    **5. Sphericity**
    ...
    """
    return (2 * numpy.sqrt(numpy.pi * coefficients['Surface'])) / coefficients['Perimeter']
  ...
  def getSphericalDisproportionFeatureValue(coefficients):
    ...
    **6. Spherical Disproportion**
    ...
    .. note::
      ...
      features.
    """
    return 1.0 / RadiomicsShape2D.getSphericityFeatureValue(coefficients)

  @staticmethod
  def getMaximumDiameterFeatureValue(coefficients):
    r"""
  ...
  def getMajorAxisLengthFeatureValue(coefficients):
    ...
    **8. Major Axis Length**
    ...
    if eigenValues[1] < 0:
      logger = logging.getLogger(RadiomicsShape2D.__module__)
      logger.warning('Major axis eigenvalue negative! (%g)', eigenValues[1])
      return numpy.nan
  ...
  def getMinorAxisLengthFeatureValue(coefficients):
    ...
    **9. Minor Axis Length**
    ...
    if eigenValues[0] < 0:
      logger = logging.getLogger(RadiomicsShape2D.__module__)
      logger.warning('Minor axis eigenvalue negative! (%g)', eigenValues[0])
      return numpy.nan
  ...
  def getElongationFeatureValue(coefficients):
    ...
    **10. Elongation**
    ...
    if eigenValues[0] < 0 or eigenValues[1] < 0:
      logger = logging.getLogger(RadiomicsShape2D.__module__)
      logger.warning('Elongation eigenvalue negative! (%g, %g)', eigenValues[0], eigenValues[1])
      return numpy.nan
    return numpy.sqrt(eigenValues[0] / eigenValues[1])
